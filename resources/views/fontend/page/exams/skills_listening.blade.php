                                ...
                                <div class="col-6" style="padding: 0 30px 10px 30px;">
                                    ...
                                    <div class="box-bg py-5">
                                        ...
                                        <div class="">
                                            ...
                                            @if($countAnswer == 1)
                                               <textarea style="margin-top: -10px ;margin-bottom: 10px" class="form-control" name="listening_answers[{{ $itemsQuestionChildren->question_id }}]" rows="1"></textarea> 
                                            @else
                                                @foreach($answer as $key=>$itemAnswer)
                                                <div class="rdio fw-bold d-flex listening_radio"> 
                                                    <input value="{{ $itemAnswer->answer_id }}" name="listening_answers[{{ $itemsQuestionChildren->question_id }}]" id="{{ $itemAnswer->answer_id }}{{ $itemsQuestionChildren->question_id }}" type="radio">
