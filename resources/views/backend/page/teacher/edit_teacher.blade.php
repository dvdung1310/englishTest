    ...
    <div id="app-content">
        <div class="app-content-area">
            <div class="container_create_studen mt-3 p-4">
                ...
                @endif
                <form class="g-3 mt-5" action="{{ route('teacher.update',$teacher->admin_id) }}" method="post">
                    {{ csrf_field() }}
                    @method('put')
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required name="admin_name"
                                id="admin_name" value="{{$teacher->admin_name}}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required name="admin_user"
                                id="admin_user" value="{{$teacher->admin_user}}">
                            {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" required name="admin_password"
                                id="admin_password" value="{{$teacher->admin_password}}">
                            {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control" required id="admin_email" name="admin_email"
                                aria-describedby="emailHelp" value="{{$teacher->admin_email}}">
                            {{-- <div id="emailHelp" class="form-text">We'll never share your email with anyone else.</div> --}}
                        </div>
