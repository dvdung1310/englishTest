                ...
                <div class="col-md-8 email_template">
                    ...
                    <div class="container_content_email">
                        ...
                        <div class="container_body_content">
                            <h4 class="text-center">Chào mừng {{ $data->student_lastname }} {{ $data->student_firstname }} đến với VUE</h4>
                            <p class="text-center">Dưới đây là thông tin đăng nhập của bạn</p>
                           <div class="d-flex justify-content-center">
                            <ul >
                                <li>Tài khoản: {{ $data->student_username }}</li>
                                <li>Mật khẩu: {{ $data->student_password }} </li>
                            </ul>
                           </div>
