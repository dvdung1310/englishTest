                    ...
                    <div class="col-lg-12 col-12">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex">
                                ...
                                <a href="{{ route('detail_question_listening', ['question_music_id' => $question_music->question_id, 'question_cate_id' => $item->question_id]) }}">
                                ...
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" href="#pills-home"
                                           role="tab" aria-controls="pills-home" aria-selected="true">+ Thêm câu hỏi</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="tab-content p-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                 ...
                                 <div class="card mb-4">
                                    <form action="{{ route('store_question_listening') }}" method="post" enctype="multipart/form-data">
                                        @csrf
